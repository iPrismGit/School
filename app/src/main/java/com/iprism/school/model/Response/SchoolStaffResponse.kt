...
data class SchoolStaffResponse(
    val message: String,
    val response: ResponseSchoolStaff,
    val status: Boolean
)

data class ResponseSchoolStaff(
    val staff_details: List<StaffDetailList>
)

data class StaffDetailList(
