...
data class TeacherGroupStudentsResponse(
    val message: String,
    val response: ResponseTeacherGroupStudent,
    val status: Boolean
)

data class ResponseTeacherGroupStudent(
    val groups: List<GroupStudents>
)

data class GroupStudents(
    val address: String,
