...
class SentMessagesAdapter(var activity: Context,
                          var response: List<SentMessage>,
                          var OnItemBtn: ((SentMessage)  ->Unit )? = null,
                          var starBtn: ((SentMessage)  ->Unit )? = null,
                          var OnItemCallPic: ((SentMessage)  ->Unit )? = null)
    ...
    override fun onBindViewHolder(holder: ViewHolders, position: Int) {
            ...
            Glide.with(activity)
                .load(Constants.IMAGES_URL+response[position].date)
                .placeholder(R.drawable.chat)
                .into(holder.binding.imgg)

//        if (response[position].read_message == ""){
//            holder.binding.nameTv.setTypeface(null, Typeface.BOLD)
//            holder.binding.subjectTv.setTypeface(null, Typeface.BOLD)
//            holder.binding.msgTv.setTypeface(null, Typeface.BOLD)
//            holder.binding.dateTv.setTypeface(null, Typeface.BOLD)
//        }else{
...
//
//            holder.binding.nameTv.setTypeface(null, Typeface.NORMAL)
//            holder.binding.subjectTv.setTypeface(null, Typeface.NORMAL)
//            holder.binding.msgTv.setTypeface(null, Typeface.NORMAL)
//            holder.binding.dateTv.setTypeface(null, Typeface.NORMAL)
//        }
//
