...
class DayCareMessagesViewModel(var repository: DayCareMessagesRepository) : ViewModel() {
    ...
    fun fetchChats(request: DayCareMessagesApiRequest) {
        viewModelScope.launch {
            _messagesResponse.value = UiState.Loading
            try {
                val response = repository.fetchAndInsertDayCareMessages(request)
                if (response.status) {
    ...
    fun insertMessage(request: DayCareMessagesApiRequest) {
        viewModelScope.launch {
    ...
    fun fetchMessages(request : DayCareMessagesApiRequest) {
        viewModelScope.launch {
    ...
    fun fetchNewMessages(request : DayCareMessagesApiRequest) {
        viewModelScope.launch {
