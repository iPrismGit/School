...
class CreateDayCareAlbumsActivity : BaseActivity() {
    ...
    private fun observeInsertAlbumCoverResponse() {
        albumsViewModel.insertDayCareAlbumCoversResponse.observe(this) { result ->
            ...
            when (result) {
                ...
                is UiState.Success -> {
                    ...
                    var intent = Intent(this, DayCareAlbumDetailsActivity::class.java)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK && data != null) {
            ...
            val uri: Uri = getImageUri(this@CreateDayCareAlbumsActivity, bitmap)!!
    ...
    private fun handleCreateBtn() {
        binding.createBtn.setOnClickListener { view ->
            if (getDate().isEmpty()){
            ...
            } else if (planId.equals("-1", true)){
                ToastUtils.showErrorCustomToast(this, "Please Select Plan..!")
                ...
                var request = DayCareAlbumsApiRequest(userDetails[User.ACADEMIC_YEAR_ID].toString(),
                    userDetails[User.SCHOOL_ID].toString(), planId, DateTimeUtils.dateMonthYear,
                    getDescription(), convertUriToBase64Image(profileUri), 1,
                    getTitleName(), userDetails[User.ID].toString(), "insert")
                albumsViewModel.insertDayCareAlbumCovers(request)
            }
        }
    }
