...
import com.iprism.school.databinding.FragmentDayCareEventsBinding
...
class DayCareEventsFragment : BaseFragment() {

    private lateinit var binding: FragmentDayCareEventsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDayCareEventsBinding.inflate(inflater, container, false)
        initViewModel()
        setupRecyclerView()
        handleRightArrow()
        handleLeftArrow()
