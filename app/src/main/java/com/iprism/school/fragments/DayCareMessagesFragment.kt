...
class DayCareMessagesFragment : BaseFragment() {

    private var _binding: FragmentDayCareMessagesBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDayCareMessagesBinding.inflate(inflater, container, false)
    ...
    private fun initViewModel() {
        val repository = DayCareMessagesRepository(requireContext())
        viewModel = ViewModelProvider(this, ViewModelFactory {
            DayCareMessagesViewModel(repository)
        })[DayCareMessagesViewModel::class.java]
    }
